...
TRANSLATIONS = {
    "tr": {
        ...
        "label_selected_pipe": "Seçilen Boru",
        "label_limit_velocity": "Limit Hız",
        "label_alternative_options": "Alternatif Seçenekler",
        "label_no_pipe_found": "Uygun Boru Yok",
        "label_mass_flow": "Kütlesel Debi",
...
""",
        ...
        ################################
        # Rapor Bölümleri / Report Sections
        ################################
        "report_title": "=== HESAPLAMA SONUCU ===",
        "report_target_pressure_drop": "Hedef: Cikis Basinci",
        "report_target_max_length": "Hedef: Maksimum Uzunluk",
        "report_target_min_diameter": "Hedef: Minimum Cap Secimi",
        "report_phase_section": "=== FAZ DURUMU ===",
        "report_phase_section_warn": "=== FAZ DURUMU [UYARI] ===",
        "report_composition_section": "=== GIRILEN KOMPOZISYON ===",
        "report_props_inlet": "=== AKISKAN OZELLIKLERI (GIRIS PT) ===",
        "report_props_outlet": "=== AKISKAN OZELLIKLERI (CIKIS PT) ===",
        "report_selected_pipe": "=== SECILEN BORU (ASME B36.10M) ===",
        "report_performance": "=== PERFORMANS (SECILEN) ===",
        "report_alternatives": "=== ALTERNATIF SENARYOLAR ===",
        "label_inlet_pressure": "Giris Basinci",
        "label_outlet_pressure": "Cikis Basinci",
        "label_total_pressure_drop": "Toplam Basinc Kaybi",
        "label_pipe_loss": "Boru Kaybi",
        "label_fitting_loss": "Fitting Kaybi",
        "label_accel_term": "Ivmelenme Terimi",
        "label_inlet_velocity": "Giris Hizi",
        "label_outlet_velocity": "Cikis Hizi",
        "label_reynolds": "Reynolds",
        "label_friction_factor": "Surtunme Faktoru (f)",
        "label_max_length": "Maksimum Uzunluk",
        "label_pressure_bara": "bara",
        "label_pressure_bar": "bar",
        "label_velocity_ms": "m/s",
        "label_mass_flow_kgs": "kg/s",
        "label_fluid_phase": "Akiskan Fazi",
        "label_vapor_quality": "Buhar Kalitesi (Q)",
        "label_formula_set": "Kullanilan Formul Seti",
        "label_two_phase_transition": "Iki Faz Gecis Mesafesi",
        "label_warning": "Uyari",
        "label_note_viscosity_fallback": "Not: Viskozite degeri fallback tahmininden alindi.",
        "label_note_thermo_fallback": "Not: Termodinamik fallback kullanildi.",
        "label_note_thermo_fallback_reason": "Not: Termodinamik fallback kullanildi ({reason}).",
        "label_max_velocity_limit": "Maksimum Hiz Limiti",
        "label_min_diameter_required": "Gerekli Min. Ic Cap (Tahmini)",
        "label_actual_flow_rate": "Gercek Akis Hizi (Giris)",
        "label_no_suitable_pipe": "UYARI: Kriterlere uygun standart boru bulunamadi!",
        "label_nominal_diameter": "Nominal Cap",
        "label_schedule": "Schedule",
        "label_outer_diameter": "Dis Cap",
        "label_wall_thickness": "Et Kalinligi",
        "label_inner_diameter": "Ic Cap",
        "label_required_wall_thickness": "Gerekli Et Kalinligi (Mukavemet)",
        "label_status": "Durum",
        "label_density": "Yogunluk",
        "label_standard_density": "Standart Yogunluk",
        "label_molecular_weight": "Molekuler Agirlik",
        "label_viscosity": "Viskozite",
        "label_compressibility": "Sikistirilabilirlik Faktoru (Z)",
        "label_cp": "Cp",
        "label_cv": "Cv",
        "label_sonic_velocity": "Ses Hizi",
        "label_error": "HATA",
        "label_message": "Mesaj",
        "unit_kg_m3": "kg/m3",
        "unit_kg_kmol": "kg/kmol",
        "unit_pa_s": "Pa.s",
        "unit_kj_kgk": "kJ/kg.K",
        "unit_mm": "mm",
        "unit_m": "m",
        "alt_thicker": "Daha Kalin Etli (Ayni Cap)",
        "alt_thinner": "Bir Alt Cap (Hiz Limiti Asildi)",
        "alt_lowest_weight": "En Dusuk Agirlikli Boru",
        "alt_unit_weight": "Birim Agirlik",
        "alt_outlet_velocity": "Cikis Hizi",
        "alt_outlet_pressure": "Cikis Basinci",
    },
    ...
    "en": {
        ...
        "label_selected_pipe": "Selected Pipe",
        "label_limit_velocity": "Limit Velocity",
        "label_alternative_options": "Alternative Options",
        "label_no_pipe_found": "No Suitable Pipe",
        "label_mass_flow": "Mass Flow",
...
""",
        ...
        # Report Sections
        ################################
        "report_title": "=== CALCULATION RESULT ===",
        "report_target_pressure_drop": "Target: Outlet Pressure",
        "report_target_max_length": "Target: Maximum Length",
        "report_target_min_diameter": "Target: Minimum Diameter Selection",
        "report_phase_section": "=== PHASE STATUS ===",
        "report_phase_section_warn": "=== PHASE STATUS [WARNING] ===",
        "report_composition_section": "=== INPUT COMPOSITION ===",
        "report_props_inlet": "=== FLUID PROPERTIES (INLET PT) ===",
        "report_props_outlet": "=== FLUID PROPERTIES (OUTLET PT) ===",
        "report_selected_pipe": "=== SELECTED PIPE (ASME B36.10M) ===",
        "report_performance": "=== PERFORMANCE (SELECTED) ===",
        "report_alternatives": "=== ALTERNATIVE SCENARIOS ===",
        "label_inlet_pressure": "Inlet Pressure",
        "label_outlet_pressure": "Outlet Pressure",
        "label_total_pressure_drop": "Total Pressure Drop",
        "label_pipe_loss": "Pipe Loss",
        "label_fitting_loss": "Fitting Loss",
        "label_accel_term": "Acceleration Term",
        "label_inlet_velocity": "Inlet Velocity",
        "label_outlet_velocity": "Outlet Velocity",
        "label_reynolds": "Reynolds",
        "label_friction_factor": "Friction Factor (f)",
        "label_max_length": "Maximum Length",
        "label_pressure_bara": "bara",
        "label_pressure_bar": "bar",
        "label_velocity_ms": "m/s",
        "label_mass_flow_kgs": "kg/s",
        "label_fluid_phase": "Fluid Phase",
        "label_vapor_quality": "Vapor Quality (Q)",
        "label_formula_set": "Formula Set Used",
        "label_two_phase_transition": "Two-Phase Transition Distance",
        "label_warning": "Warning",
        "label_note_viscosity_fallback": "Note: Viscosity value from fallback estimation.",
        "label_note_thermo_fallback": "Note: Thermodynamic fallback used.",
        "label_note_thermo_fallback_reason": "Note: Thermodynamic fallback used ({reason}).",
        "label_max_velocity_limit": "Max Velocity Limit",
        "label_min_diameter_required": "Required Min. Inner Diameter (Estimated)",
        "label_actual_flow_rate": "Actual Flow Rate (Inlet)",
        "label_no_suitable_pipe": "WARNING: No suitable standard pipe found!",
        "label_nominal_diameter": "Nominal Diameter",
        "label_schedule": "Schedule",
        "label_outer_diameter": "Outer Diameter",
        "label_wall_thickness": "Wall Thickness",
        "label_inner_diameter": "Inner Diameter",
        "label_required_wall_thickness": "Required Wall Thickness (Strength)",
        "label_status": "Status",
        "label_density": "Density",
        "label_standard_density": "Standard Density",
        "label_molecular_weight": "Molecular Weight",
        "label_viscosity": "Viscosity",
        "label_compressibility": "Compressibility Factor (Z)",
        "label_cp": "Cp",
        "label_cv": "Cv",
        "label_sonic_velocity": "Sonic Velocity",
        "label_error": "ERROR",
        ...
        "unit_mm": "mm",
        "unit_m": "m",
        "alt_thicker": "Thicker Wall (Same NPS)",
        "alt_thinner": "One Size Smaller (Velocity Exceeded)",
        "alt_lowest_weight": "Lowest Weight Pipe",
        "alt_unit_weight": "Unit Weight",
        "alt_outlet_velocity": "Outlet Velocity",
        "alt_outlet_pressure": "Outlet Pressure",
    }
}
