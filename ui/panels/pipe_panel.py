...
class PipePanel(ttk.LabelFrame):
    ...
    def setup_ui(self):
        ...
        ttk.Entry(self.app.design_frame, textvariable=self.app.p_design_var, width=10).grid(row=0, column=1, padx=5)
        ...
        ent_f = ttk.Entry(self.app.design_frame, textvariable=self.app.factor_f, width=6)
        ...
        ent_e = ttk.Entry(self.app.design_frame, textvariable=self.app.factor_e, width=6)
        ...
        ent_t = ttk.Entry(self.app.design_frame, textvariable=self.app.factor_t, width=6)
