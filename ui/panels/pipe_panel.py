...
class PipePanel(ttk.LabelFrame):
    ...
    def setup_ui(self):
        ...
        self.app.ent_smys = ValidatedEntry(
            geo_frame, 
            textvariable=self.app.smys_var, 
            width=8,
        ...
        self.app.ent_len = ValidatedEntry(
            geo_frame, 
            textvariable=self.app.len_var, 
            width=10,
            validation_type="float",
            min_value=0.0001,
            allow_zero=False,
        ...
        self.app.ent_diam = ValidatedEntry(
            geo_frame, 
            textvariable=self.app.diam_var, 
            width=10,
            validation_type="float",
            min_value=0.0001,
            allow_zero=False,
        ...
        self.app.ent_thick = ValidatedEntry(
            geo_frame, 
            textvariable=self.app.thick_var, 
            width=10,
            validation_type="float",
            min_value=0.0001,
            allow_zero=False,
        ...
        self.app.ent_target_p = ValidatedEntry(
            geo_frame, 
            textvariable=self.app.target_p_var, 
            width=10,
            validation_type="float",
            min_value=0.0001,
            allow_zero=False,
        ...
        self.app.ent_max_vel = ValidatedEntry(
            geo_frame, 
            textvariable=self.app.max_vel_var, 
            width=10,
            validation_type="float",
            min_value=0.0001,
            allow_zero=False,
        ...
        self.app.ent_p_design = ValidatedEntry(
            self.app.design_frame, 
            textvariable=self.app.p_design_var, 
            width=10,
            validation_type="float",
            min_value=0.0001,
            allow_zero=False,
        ...
        self.app.ent_factor_f = ValidatedEntry(
            self.app.design_frame, 
            textvariable=self.app.factor_f, 
            width=6,
            validation_type="float",
            min_value=0.01,
            max_value=1.0,
        ...
        self.app.ent_factor_e = ValidatedEntry(
            self.app.design_frame, 
            textvariable=self.app.factor_e, 
            width=6,
            validation_type="float",
            min_value=0.01,
            max_value=1.0,
        ...
        self.app.ent_factor_t = ValidatedEntry(
            self.app.design_frame, 
            textvariable=self.app.factor_t, 
            width=6,
            validation_type="float",
            min_value=0.01,
            max_value=1.0,
